        ...
        return (
            <div className="row blueback">
                <div className="currentBGStyle">
                    <h1><strong>CURRENT ACCOUNTS</strong></h1>
                    <h4>Meet the demanding day-to-day needs of your business</h4>
                </div>
                <div className="row">
                    <center>
                        <h3><strong>CURRENT ACCOUNTS</strong></h3>
                    ...
                    <div id="savingLinkDiv" className="col-md-12 col-sm-12 col-xs-12 savingNormalText">
                        <div className="row">
                            ...
                            <div className="col-md-8 col-sm-12 col-xs-12">
                                Hi Amit,<br/>You are maintaining the below Current Accounts with YES BANK. Please select the Account mentioned below to view details.
                                <div className="row">
                                    <br/>
                                    <center>
                    ...
                    <div id="savingDetailsDiv1" className="savingNormalText">
                        <div className="col-md-2"></div>
                        <div className="col-md-8 col-sm-12 col-xs-12">
                            {/*<div className="rightAlignStyle" onClick={this.onBack.bind(this)}><u>Go back to Current Accounts</u></div><br/>*/}
                            Hi Amit,<br/>You are maintaining the Current Account Advantage with YES BANK, which has the following benefits for you.<br/>
                            ...
                            <br/>
                            The following information is registered with us with respect to your Current Account against <span className="savingTitle">CUSTOMER ID</span> 12345:
                            <div className="row">
                                <div className="col-md-6 col-sm-6 col-xs-12">
                        ...
                        <div className="col-md-12 col-sm-12 col-xs-12">
                            ...
                            <div className="row transactionStyle">
                                ...
                                <div className="col-md-7 col-sm-9 col-xs-8">
                                    ...
                                    Click here to get the list of all transactions on your YES BANK Current Account as on 30th October 2016.<br/>
                    ...
                    <div id="savingDetailsDiv2" className="savingNormalText">
                        ...
                        <div className="col-md-8 col-sm-12 col-xs-12">
                            {/*<div className="rightAlignStyle" onClick={this.onBack.bind(this)}><u>Go back to Current Accounts</u></div><br/>*/}
                            Hi Amit,<br/>You are maintaining the Current Account Value with YES BANK, which has the following benefits for you.<br/>
                            <li>Higher interest rate of 6% p.a.</li>
                            <li>Unlimited free transaction on any ATM across the country.</li>
                            <li>Free demand draft and payable at-par cheque</li>
                            <br/>
